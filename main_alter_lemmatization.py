...
keywords = {
    ...
    'liver cancer': ['liver cancer', 'liver cancers','liver carcinoma', 'liver carcinomas', 'liver adenocarcinoma', 'hepatic carcinoma', 'boundary of tumor and liver', 'hepatic carcinomas', 'hepatic adenocarcinoma', 'hepatic adenocarcinomas', 'hepatic malignancy', 'hepatic malignancies', 'liver adenocarcinomas', 'liver malignancy', 'liver malignancies', 'liver tumor', 'liver tumors', 'liver neoplasm', 'liver neoplasms', 'hepatocellular carcinoma', 'hepatic adenoma', 'fibrolamellar carcinoma', 'hepatic hemangioma', 'cholangiocarcinoma', 'intrahepatic cholangiocarcinoma', 'hcc', 'hepatocellular carcinoma', 'cirrhosis', 'hepatitis b', 'afp', 'cholangioscopy'],
    ...
    'esophageal cancer': ['esophageal cancer', 'esophageal tumor', 'oesophageal squamous cell carcinoma', 'oesophagectomy', 'oesophageal cancer', 'esophageal and esophagogastric junction adenocarcinomas', 'adenocarcinoma of the esophagogastric junction', 'oesophagectomy', 'barretts neoplasia', 'barretts esophagus', 'esophageal adenocarcinoma', 'esophageal squamous cell carcinoma', 'esophagectomy', 'dysphagia', 'gerd', 'gastroesophageal reflux disease', 'esophageal carcinoma', 'esophageal carcinomas', 'esophageal adenocarcinoma', 'esophageal adenocarcinomas', 'esophageal malignancy', 'esophageal malignancies'],
